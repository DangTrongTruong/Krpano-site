...
function GameObject() {
  ...
  /**
    ...
    */
  this.startupGameObject = function (
    /**Number*/ x,
    /**Number*/ y,
    /**Number*/ z
  ) {
...
function RepeatingGameObject() {
  ...
  /**
    ...
    */
  this.startupRepeatingGameObject = function (
    image,
    x,
    y,
    z,
  ...
  this.drawRepeat = function (
    ...
    var width =
      newFillArea[0] < this.image.width - left
        ? newFillArea[0]
        : this.image.width - left;
    var height =
      newFillArea[1] < this.image.height - top
        ? newFillArea[1]
...
function AnimatedGameObject() {
  ...
  /**
    ...
    */
  this.startupAnimatedGameObject = function (
    /**Image*/ image,
    /**Number*/ x,
    /**Number*/ y,
    /**Number*/ z,
...
function ApplicationManager() {
  ...
  this.startupApplicationManager = function () {
    this.runner = new AnimatedGameObject().startupAnimatedGameObject(
      g_run,
      0,
      0,
      1,
